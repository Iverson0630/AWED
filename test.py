...
parser.add_argument('--model', type=str,
                    default='drct', help='segformer or transunet')
parser.add_argument('--model_path', type=str,  default='output/data1k/grid_mean_train/unet32_wavel1mlp/_50k_epo400_bs32_lr0.001_224/epoch_399.pth')  
...
parser.add_argument('--save_path', type=str, default='../../data/data1k/result/unet_wavel1/', help='save_path')
...
def inference(args, model, test_save_path):
    ...
    count = 0.0
    draw_size = 4
    for i_batch, (image_batch,label_batch,img_name) in tqdm(enumerate(testloader)):
        ...
        for i in range(len(outputs)):
            ...
            img_path = os.path.join(test_save_path, img_name[i])
